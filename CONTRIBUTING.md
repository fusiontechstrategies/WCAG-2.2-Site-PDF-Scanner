...
python -m unittest -v tests.test_core_regressions tests.test_adoption_assets tests.test_normalize_sdist tests.test_normalize_wheel tests.test_release_assets
